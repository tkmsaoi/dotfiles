...
;;
;; Custom Theme (Based on dracula-theme.el)
;;

(deftheme dracula-mod)
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((,class (:inverse-video nil :background ,bg3))))
...
(provide-theme 'dracula-mod)

(enable-theme 'dracula-mod)
